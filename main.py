...
from src.tasks.consolidate_documentation_task import consolidate_documentation_task
from src.tasks.devops_task import devops_task
from src.tasks.initial_task import initial_task
from src.tasks.project_brief_task import project_brief_task
...
task_to_consolidate_documentation = consolidate_documentation_task(task_which_that_depends=task_to_plan_infra)
task_to_create_project_brief = project_brief_task(task_which_that_depends=task_to_consolidate_documentation)
