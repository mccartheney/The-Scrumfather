...
def devops_task (task_which_that_depends) :
  return Task(
      description="""Based on the system architecture, user stories, database schema, and technical tasks from previous tasks,
      design a robust infrastructure and CI/CD pipeline with focus on reliability and performance.
      Ensure the infrastructure supports all the features and technical requirements defined in previous tasks.""",
      expected_output = (
